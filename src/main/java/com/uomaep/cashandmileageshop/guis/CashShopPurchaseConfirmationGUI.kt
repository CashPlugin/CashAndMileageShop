...
class CashShopPurchaseConfirmationGUI: InventoryHolder {
    private val inventory: Inventory
    var ogEvent: InventoryClickEvent? = null
    var ogCashItemDTO: CashItemDTO? = null
    var ogshopItemClickEventCash: CashShopItemClickEvent? = null
    ...
    constructor(sender: CommandSender,
                ...
                cashShopItemClickEvent: CashShopItemClickEvent
    ) {
        this.inventory = Bukkit.createInventory(this, 27, name)
        ogEvent = e
        ogCashItemDTO = cashItemDTO
        ogshopItemClickEventCash = cashShopItemClickEvent
